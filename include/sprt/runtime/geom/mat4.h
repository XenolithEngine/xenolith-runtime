...
#ifndef RUNTIME_INCLUDE_SPRT_RUNTIME_GEOM_MAT4_H_
#define RUNTIME_INCLUDE_SPRT_RUNTIME_GEOM_MAT4_H_
 ...
 * @see Transform
 */
class SPRT_API alignas(16) Mat4 {
public:
...
template <>
struct io_traits<geom::Mat4> {
	template <io_character CharType>
	static void encode(const callback<void(StringViewBase<CharType>)> &os, const geom::Mat4 &m) {
...
#endif /* RUNTIME_INCLUDE_SPRT_RUNTIME_GEOM_MAT4_H_ */
