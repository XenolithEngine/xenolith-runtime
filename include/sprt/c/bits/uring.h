...
#ifndef CORE_RUNTIME_INCLUDE_C_BITS_URING_H_
#define CORE_RUNTIME_INCLUDE_C_BITS_URING_H_

// Extracted from linux headers and adopted for SPRT
...
typedef __SPRT_ID(int8_t) _ring_s8;
typedef __SPRT_ID(uint8_t) _ring_u8;

typedef __SPRT_ID(int16_t) _ring_s16;
typedef __SPRT_ID(uint16_t) _ring_u16;

typedef __SPRT_ID(int32_t) _ring_s32;
typedef __SPRT_ID(uint32_t) _ring_u32;

typedef __SPRT_ID(int64_t) _ring_s64;
typedef __SPRT_ID(uint64_t) _ring_u64;
...
struct io_uring_sync_cancel_reg {
	...
	_ring_s32 fd;
	_ring_u32 flags;
	struct __SPRT_TIMESPEC_NAME timeout;
	_ring_u8 opcode;
	_ring_u8 pad[7];
	_ring_u64 pad2[3];
};
...
#endif // CORE_RUNTIME_INCLUDE_C_BITS_URING_H_
