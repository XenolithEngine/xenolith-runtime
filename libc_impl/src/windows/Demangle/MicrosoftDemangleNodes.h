...
enum class StorageClass : sprt::uint8_t {
	None,
	PrivateStatic,
	ProtectedStatic,
	PublicStatic,
...
// Calling conventions
enum class CallingConv : sprt::uint8_t {
	None,
	Cdecl,
	Pascal,
	Thiscall,
...
enum class ReferenceKind : sprt::uint8_t {
	None,
	LValueRef,
	RValueRef
};
...
enum class IntrinsicFunctionKind : sprt::uint8_t {
	None,
	New, // ?2 # operator new
...
struct Node {
	...
	sprt::__malloc_string toString(OutputFlags Flags = OF_Default) const;
...
struct IdentifierNode : public Node {
	...
	static bool classof(const Node *N) {
		return N->kind() >= NodeKind::IdentifierStart && N->kind() <= NodeKind::IdentifierEnd;
	}
...
struct VcallThunkIdentifierNode : public IdentifierNode {
	...
	sprt::uint64_t OffsetInVTable = 0;
};
...
struct ThunkSignatureNode : public FunctionSignatureNode {
	...
	struct ThisAdjustor {
		sprt::uint32_t StaticOffset = 0;
		sprt::int32_t VBPtrOffset = 0;
		sprt::int32_t VBOffsetOffset = 0;
		sprt::int32_t VtordispOffset = 0;
	};
...
struct NodeArrayNode : public Node {
	...
	void output(OutputBuffer &OB, OutputFlags Flags, sprt::StringView Separator) const;
...
struct TemplateParameterReferenceNode : public Node {
	...
	sprt::array<sprt::int64_t, 3> ThunkOffsets;
	PointerAffinity Affinity = PointerAffinity::None;
...
struct IntegerLiteralNode : public Node {
	...
	IntegerLiteralNode(sprt::uint64_t Value, bool IsNegative)
...
struct RttiBaseClassDescriptorNode : public IdentifierNode {
	...
	sprt::uint32_t NVOffset = 0;
	sprt::int32_t VBPtrOffset = 0;
	sprt::uint32_t VBTableOffset = 0;
	sprt::uint32_t Flags = 0;
};
...
struct SymbolNode : public Node {
	...
	static bool classof(const Node *N) {
		return N->kind() >= NodeKind::SymbolStart && N->kind() <= NodeKind::SymbolEnd;
	}
...
struct PointerAuthQualifierNode : public Node {
	...
	typedef sprt::array<sprt::uint64_t, NumArgs> ArgArray;
