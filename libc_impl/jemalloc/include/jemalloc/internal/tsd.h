...
static inline bool tsd_state_nocleanup(tsd_t *tsd) {
 ...
 */
static inline void tsd_pre_reentrancy_raw(tsd_t *tsd) {
...
static inline void tsd_post_reentrancy_raw(tsd_t *tsd) {
